...
interface SkruvHtmlHTMLElement extends HTMLVnode<'html', HTMLHtmlElement, {
  ...
  interface SkruvBaseHTMLElement extends HTMLVnode<'base', HTMLBaseElement, {
  ...
  interface SkruvHeadHTMLElement extends HTMLVnode<'head', HTMLHeadElement, {
  /** The URIs of one or more metadata profiles, separated by white space. */
  'profile'?: UNKNOWN | undefined
  }, AnyHTMLContent> {}
  
  /** The <title> HTML element defines the document's title that is shown in a browser's title bar or a page's tab. It only contains text; tags within the element are ignored. */
  interface SkruvTitleHTMLElement extends HTMLVnode<'title', HTMLTitleElement, {
  }, AnyHTMLContent> {}
  
  /** The <script> HTML element is used to embed executable code or data; this is typically used to embed or refer to JavaScript code. The <script> element can also be used with other languages, such as WebGL's GLSL shader programming language and JSON. */
  interface SkruvScriptHTMLElement extends HTMLVnode<'script', HTMLScriptElement, {
  ...
  interface SkruvStyleHTMLElement extends HTMLVnode<'style', HTMLStyleElement, {
  ...
  interface SkruvLinkHTMLElement extends HTMLVnode<'link', HTMLLinkElement, {
  ...
  interface SkruvMetaHTMLElement extends HTMLVnode<'meta', HTMLMetaElement, {
  ...
  interface SkruvBodyHTMLElement extends HTMLVnode<'body', HTMLBodyElement, {
  ...
  interface SkruvAddressHTMLElement extends HTMLVnode<'address', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <article> HTML element represents a self-contained composition in a document, page, application, or site, which is intended to be independently distributable or reusable (e.g., in syndication). Examples include: a forum post, a magazine or newspaper article, or a blog entry, a product card, a user-submitted comment, an interactive widget or gadget, or any other independent item of content. */
  interface SkruvArticleHTMLElement extends HTMLVnode<'article', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <aside> HTML element represents a portion of a document whose content is only indirectly related to the document's main content. Asides are frequently presented as sidebars or call-out boxes. */
  interface SkruvAsideHTMLElement extends HTMLVnode<'aside', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <footer> HTML element represents a footer for its nearest ancestor sectioning content or sectioning root element. A <footer> typically contains information about the author of the section, copyright data or links to related documents. */
  interface SkruvFooterHTMLElement extends HTMLVnode<'footer', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <h1> to <h6> HTML elements represent six levels of section headings. <h1> is the highest section level and <h6> is the lowest. */
  interface SkruvH1HTMLElement extends HTMLVnode<'h1', HTMLHeadingElement, {
  }, AnyHTMLContent> {}
  
  /** The <header> HTML element represents introductory content, typically a group of introductory or navigational aids. It may contain some heading elements but also a logo, a search form, an author name, and other elements. */
  interface SkruvHeaderHTMLElement extends HTMLVnode<'header', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <hgroup> HTML element represents a heading and related content. It groups a single <h1>–<h6> element with one or more <p>. */
  interface SkruvHgroupHTMLElement extends HTMLVnode<'hgroup', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <main> HTML element represents the dominant content of the <body> of a document. The main content area consists of content that is directly related to or expands upon the central topic of a document, or the central functionality of an application. */
  interface SkruvMainHTMLElement extends HTMLVnode<'main', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <nav> HTML element represents a section of a page whose purpose is to provide navigation links, either within the current document or to other documents. Common examples of navigation sections are menus, tables of contents, and indexes. */
  interface SkruvNavHTMLElement extends HTMLVnode<'nav', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <section> HTML element represents a generic standalone section of a document, which doesn't have a more specific semantic element to represent it. Sections should always have a heading, with very few exceptions. */
  interface SkruvSectionHTMLElement extends HTMLVnode<'section', HTMLElement, {
  }, AnyHTMLContent> {}
  ...
  interface SkruvSearchHTMLElement extends HTMLVnode<'search', HTMLUnknownElement, {
  }, AnyHTMLContent> {}
  
  /** The <blockquote> HTML element indicates that the enclosed text is an extended quotation. Usually, this is rendered visually by indentation (see Notes for how to change it). A URL for the source of the quotation may be given using the cite attribute, while a text representation of the source can be given using the <cite> element. */
  interface SkruvBlockquoteHTMLElement extends HTMLVnode<'blockquote', HTMLQuoteElement, {
  ...
  interface SkruvCiteHTMLElement extends HTMLVnode<'cite', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <dd> HTML element provides the description, definition, or value for the preceding term (<dt>) in a description list (<dl>). */
  interface SkruvDdHTMLElement extends HTMLVnode<'dd', HTMLElement, {
  /** If the value of this attribute is set to yes, the definition text will not wrap. The default value is no. */
  'nowrap'?: UNKNOWN | undefined
  }, AnyHTMLContent> {}
  
  /** The <dt> HTML element specifies a term in a description or definition list, and as such must be used inside a <dl> element. It is usually followed by a <dd> element; however, multiple <dt> elements in a row indicate several terms that are all defined by the immediate next <dd> element. */
  interface SkruvDtHTMLElement extends HTMLVnode<'dt', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <dl> HTML element represents a description list. The element encloses a list of groups of terms (specified using the <dt> element) and descriptions (provided by <dd> elements). Common uses for this element are to implement a glossary or to display metadata (a list of key-value pairs). */
  interface SkruvDlHTMLElement extends HTMLVnode<'dl', HTMLDListElement, {
  }, AnyHTMLContent> {}
  
  /** The <div> HTML element is the generic container for flow content. It has no effect on the content or layout until styled in some way using CSS (e.g. styling is directly applied to it, or some kind of layout model like Flexbox is applied to its parent element). */
  interface SkruvDivHTMLElement extends HTMLVnode<'div', HTMLDivElement, {
  }, AnyHTMLContent> {}
  
  /** The <figcaption> HTML element represents a caption or legend describing the rest of the contents of its parent <figure> element. */
  interface SkruvFigcaptionHTMLElement extends HTMLVnode<'figcaption', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <figure> HTML element represents self-contained content, potentially with an optional caption, which is specified using the <figcaption> element. The figure, its caption, and its contents are referenced as a single unit. */
  interface SkruvFigureHTMLElement extends HTMLVnode<'figure', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <hr> HTML element represents a thematic break between paragraph-level elements: for example, a change of scene in a story, or a shift of topic within a section. */
  interface SkruvHrHTMLElement extends HTMLVnode<'hr', HTMLHRElement, {
  ...
  interface SkruvLiHTMLElement extends HTMLVnode<'li', HTMLLIElement, {
  ...
  interface SkruvOlHTMLElement extends HTMLVnode<'ol', HTMLOListElement, {
  ...
  interface SkruvUlHTMLElement extends HTMLVnode<'ul', HTMLUListElement, {
  ...
  interface SkruvMenuHTMLElement extends HTMLVnode<'menu', HTMLMenuElement, {
  }, AnyHTMLContent> {}
  
  /** The <p> HTML element represents a paragraph. Paragraphs are usually represented in visual media as blocks of text separated from adjacent blocks by blank lines and/or first-line indentation, but HTML paragraphs can be any structural grouping of related content, such as images or form fields. */
  interface SkruvPHTMLElement extends HTMLVnode<'p', HTMLParagraphElement, {
  }, AnyHTMLContent> {}
  
  /** The <pre> HTML element represents preformatted text which is to be presented exactly as written in the HTML file. The text is typically rendered using a non-proportional, or monospaced, font. Whitespace inside this element is displayed as written. */
  interface SkruvPreHTMLElement extends HTMLVnode<'pre', HTMLPreElement, {
  ...
  interface SkruvAHTMLElement extends HTMLVnode<'a', HTMLAnchorElement, {
  ...
  interface SkruvAbbrHTMLElement extends HTMLVnode<'abbr', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <b> HTML element is used to draw the reader's attention to the element's contents, which are not otherwise granted special importance. This was formerly known as the Boldface element, and most browsers still draw the text in boldface. However, you should not use <b> for styling text or granting importance. If you wish to create boldface text, you should use the CSS font-weight property. If you wish to indicate an element is of special importance, you should use the <strong> element. */
  interface SkruvBHTMLElement extends HTMLVnode<'b', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <bdi> HTML element tells the browser's bidirectional algorithm to treat the text it contains in isolation from its surrounding text. It's particularly useful when a website dynamically inserts some text and doesn't know the directionality of the text being inserted. */
  interface SkruvBdiHTMLElement extends HTMLVnode<'bdi', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <bdo> HTML element overrides the current directionality of text, so that the text within is rendered in a different direction. */
  interface SkruvBdoHTMLElement extends HTMLVnode<'bdo', HTMLElement, {
  ...
  interface SkruvBrHTMLElement extends HTMLVnode<'br', HTMLBRElement, {
  }, AnyHTMLContent> {}
  
  /** The <code> HTML element displays its contents styled in a fashion intended to indicate that the text is a short fragment of computer code. By default, the content text is displayed using the user agent's default monospace font. */
  interface SkruvCodeHTMLElement extends HTMLVnode<'code', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <data> HTML element links a given piece of content with a machine-readable translation. If the content is time- or date-related, the <time> element must be used. */
  interface SkruvDataHTMLElement extends HTMLVnode<'data', HTMLDataElement, {
  ...
  interface SkruvDfnHTMLElement extends HTMLVnode<'dfn', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <em> HTML element marks text that has stress emphasis. The <em> element can be nested, with each level of nesting indicating a greater degree of emphasis. */
  interface SkruvEmHTMLElement extends HTMLVnode<'em', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <i> HTML element represents a range of text that is set off from the normal text for some reason, such as idiomatic text, technical terms, taxonomical designations, among others. Historically, these have been presented using italicized type, which is the original source of the <i> naming of this element. */
  interface SkruvIHTMLElement extends HTMLVnode<'i', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <kbd> HTML element represents a span of inline text denoting textual user input from a keyboard, voice input, or any other text entry device. By convention, the user agent defaults to rendering the contents of a <kbd> element using its default monospace font, although this is not mandated by the HTML standard. */
  interface SkruvKbdHTMLElement extends HTMLVnode<'kbd', HTMLElement, {
  }, AnyHTMLContent> {}
  ...
  interface SkruvMarkHTMLElement extends HTMLVnode<'mark', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <q> HTML element indicates that the enclosed text is a short inline quotation. Most modern browsers implement this by surrounding the text in quotation marks. This element is intended for short quotations that don't require paragraph breaks; for long quotations use the <blockquote> element. */
  interface SkruvQHTMLElement extends HTMLVnode<'q', HTMLQuoteElement, {
  /** The value of this attribute is a URL that designates a source document or message for the information quoted. This attribute is intended to point to information explaining the context or the reference for the quote. */
  'cite'?: string | undefined
  }, AnyHTMLContent> {}
  
  /** The <rp> HTML element is used to provide fall-back parentheses for browsers that do not support display of ruby annotations using the <ruby> element. One <rp> element should enclose each of the opening and closing parentheses that wrap the <rt> element that contains the annotation's text. */
  interface SkruvRpHTMLElement extends HTMLVnode<'rp', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <ruby> HTML element represents small annotations that are rendered above, below, or next to base text, usually used for showing the pronunciation of East Asian characters. It can also be used for annotating other kinds of text, but this usage is less common. */
  interface SkruvRubyHTMLElement extends HTMLVnode<'ruby', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <rt> HTML element specifies the ruby text component of a ruby annotation, which is used to provide pronunciation, translation, or transliteration information for East Asian typography. The <rt> element must always be contained within a <ruby> element. */
  interface SkruvRtHTMLElement extends HTMLVnode<'rt', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <s> HTML element renders text with a strikethrough, or a line through it. Use the <s> element to represent things that are no longer relevant or no longer accurate. However, <s> is not appropriate when indicating document edits; for that, use the <del> and <ins> elements, as appropriate. */
  interface SkruvSHTMLElement extends HTMLVnode<'s', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <samp> HTML element is used to enclose inline text which represents sample (or quoted) output from a computer program. Its contents are typically rendered using the browser's default monospaced font (such as Courier or Lucida Console). */
  interface SkruvSampHTMLElement extends HTMLVnode<'samp', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <small> HTML element represents side-comments and small print, like copyright and legal text, independent of its styled presentation. By default, it renders text within it one font-size smaller, such as from small to x-small. */
  interface SkruvSmallHTMLElement extends HTMLVnode<'small', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <span> HTML element is a generic inline container for phrasing content, which does not inherently represent anything. It can be used to group elements for styling purposes (using the class or id attributes), or because they share attribute values, such as lang. It should be used only when no other semantic element is appropriate. <span> is very much like a <div> element, but <div> is a block-level element whereas a <span> is an inline-level element. */
  interface SkruvSpanHTMLElement extends HTMLVnode<'span', HTMLSpanElement, {
  }, AnyHTMLContent> {}
  
  /** The <strong> HTML element indicates that its contents have strong importance, seriousness, or urgency. Browsers typically render the contents in bold type. */
  interface SkruvStrongHTMLElement extends HTMLVnode<'strong', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <sub> HTML element specifies inline text which should be displayed as subscript for solely typographical reasons. Subscripts are typically rendered with a lowered baseline using smaller text. */
  interface SkruvSubHTMLElement extends HTMLVnode<'sub', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <sup> HTML element specifies inline text which is to be displayed as superscript for solely typographical reasons. Superscripts are usually rendered with a raised baseline using smaller text. */
  interface SkruvSupHTMLElement extends HTMLVnode<'sup', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <time> HTML element represents a specific period in time. It may include the datetime attribute to translate dates into machine-readable format, allowing for better search engine results or custom features such as reminders. */
  interface SkruvTimeHTMLElement extends HTMLVnode<'time', HTMLTimeElement, {
  /** This attribute indicates the time and/or date of the element and must be in one of the formats described below. */
  'datetime'?: string | undefined
  }, AnyHTMLContent> {}
  
  /** The <u> HTML element represents a span of inline text which should be rendered in a way that indicates that it has a non-textual annotation. This is rendered by default as a simple solid underline, but may be altered using CSS. */
  interface SkruvUHTMLElement extends HTMLVnode<'u', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <var> HTML element represents the name of a variable in a mathematical expression or a programming context. It's typically presented using an italicized version of the current typeface, although that behavior is browser-dependent. */
  interface SkruvVarHTMLElement extends HTMLVnode<'var', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <wbr> HTML element represents a word break opportunity—a position within text where the browser may optionally break a line, though its line-breaking rules would not otherwise create a break at that location. */
  interface SkruvWbrHTMLElement extends HTMLVnode<'wbr', HTMLElement, {
  }, AnyHTMLContent> {}
  ...
  interface SkruvAreaHTMLElement extends HTMLVnode<'area', HTMLAreaElement, {
  ...
  interface SkruvAudioHTMLElement extends HTMLVnode<'audio', HTMLAudioElement, {
  ...
  interface SkruvImgHTMLElement extends HTMLVnode<'img', HTMLImageElement, {
  ...
  interface SkruvMapHTMLElement extends HTMLVnode<'map', HTMLMapElement, {
  ...
  interface SkruvTrackHTMLElement extends HTMLVnode<'track', HTMLTrackElement, {
  ...
  interface SkruvVideoHTMLElement extends HTMLVnode<'video', HTMLVideoElement, {
  ...
  interface SkruvEmbedHTMLElement extends HTMLVnode<'embed', HTMLEmbedElement, {
  ...
  interface SkruvIframeHTMLElement extends HTMLVnode<'iframe', HTMLIFrameElement, {
  ...
  interface SkruvObjectHTMLElement extends HTMLVnode<'object', HTMLObjectElement, {
  ...
  interface SkruvPictureHTMLElement extends HTMLVnode<'picture', HTMLPictureElement, {
  }, AnyHTMLContent> {}
  
  /** The <source> HTML element specifies multiple media resources for the <picture>, the <audio> element, or the <video> element. It is a void element, meaning that it has no content and does not have a closing tag. It is commonly used to offer the same media content in multiple file formats in order to provide compatibility with a broad range of browsers given their differing support for image file formats and media file formats. */
  interface SkruvSourceHTMLElement extends HTMLVnode<'source', HTMLSourceElement, {
  ...
  interface SkruvPortalHTMLElement extends HTMLVnode<'portal', HTMLUnknownElement, {
  ...
  interface SkruvSvgHTMLElement extends HTMLVnode<'svg', HTMLUnknownElement, {
  ...
  interface SkruvMathHTMLElement extends HTMLVnode<'math', HTMLUnknownElement, {
  ...
  interface SkruvCanvasHTMLElement extends HTMLVnode<'canvas', HTMLCanvasElement, {
  ...
  interface SkruvNoscriptHTMLElement extends HTMLVnode<'noscript', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <del> HTML element represents a range of text that has been deleted from a document. This can be used when rendering "track changes" or source code diff information, for example. The <ins> element can be used for the opposite purpose: to indicate text that has been added to the document. */
  interface SkruvDelHTMLElement extends HTMLVnode<'del', HTMLModElement, {
  ...
  interface SkruvInsHTMLElement extends HTMLVnode<'ins', HTMLModElement, {
  ...
  interface SkruvCaptionHTMLElement extends HTMLVnode<'caption', HTMLTableCaptionElement, {
  }, AnyHTMLContent> {}
  ...
  interface SkruvColHTMLElement extends HTMLVnode<'col', HTMLTableColElement, {
  ...
  interface SkruvColgroupHTMLElement extends HTMLVnode<'colgroup', HTMLTableColElement, {
  ...
  interface SkruvTableHTMLElement extends HTMLVnode<'table', HTMLTableElement, {
  }, AnyHTMLContent> {}
  
  /** The <tbody> HTML element encapsulates a set of table rows (<tr> elements), indicating that they comprise the body of the table (<table>). */
  interface SkruvTbodyHTMLElement extends HTMLVnode<'tbody', HTMLTableSectionElement, {
  }, AnyHTMLContent> {}
  
  /** The <tr> HTML element defines a row of cells in a table. The row's cells can then be established using a mix of <td> (data cell) and <th> (header cell) elements. */
  interface SkruvTrHTMLElement extends HTMLVnode<'tr', HTMLTableRowElement, {
  }, AnyHTMLContent> {}
  
  /** The <td> HTML element defines a cell of a table that contains data. It participates in the table model. */
  interface SkruvTdHTMLElement extends HTMLVnode<'td', HTMLTableCellElement, {
  ...
  interface SkruvTfootHTMLElement extends HTMLVnode<'tfoot', HTMLTableSectionElement, {
  }, AnyHTMLContent> {}
  ...
  interface SkruvThHTMLElement extends HTMLVnode<'th', HTMLTableCellElement, {
  ...
  interface SkruvTheadHTMLElement extends HTMLVnode<'thead', HTMLTableSectionElement, {
  }, AnyHTMLContent> {}
  
  /** The <button> HTML element is an interactive element activated by a user with a mouse, keyboard, finger, voice command, or other assistive technology. Once activated, it then performs an action, such as submitting a form or opening a dialog. */
  interface SkruvButtonHTMLElement extends HTMLVnode<'button', HTMLButtonElement, {
  ...
  interface SkruvDatalistHTMLElement extends HTMLVnode<'datalist', HTMLDataListElement, {
  }, AnyHTMLContent> {}
  
  /** The <option> HTML element is used to define an item contained in a <select>, an <optgroup>, or a <datalist> element. As such, <option> can represent menu items in popups and other lists of items in an HTML document. */
  interface SkruvOptionHTMLElement extends HTMLVnode<'option', HTMLOptionElement, {
  ...
  interface SkruvFieldsetHTMLElement extends HTMLVnode<'fieldset', HTMLFieldSetElement, {
  ...
  interface SkruvLabelHTMLElement extends HTMLVnode<'label', HTMLLabelElement, {
  ...
  interface SkruvFormHTMLElement extends HTMLVnode<'form', HTMLFormElement, {
  ...
  interface SkruvInputHTMLElement extends HTMLVnode<'input', HTMLInputElement, {
  }, AnyHTMLContent> {}
  
  /** The <legend> HTML element represents a caption for the content of its parent <fieldset>. */
  interface SkruvLegendHTMLElement extends HTMLVnode<'legend', HTMLLegendElement, {
  }, AnyHTMLContent> {}
  
  /** The <meter> HTML element represents either a scalar value within a known range or a fractional value. */
  interface SkruvMeterHTMLElement extends HTMLVnode<'meter', HTMLMeterElement, {
  ...
  interface SkruvOptgroupHTMLElement extends HTMLVnode<'optgroup', HTMLOptGroupElement, {
  ...
  interface SkruvSelectHTMLElement extends HTMLVnode<'select', HTMLSelectElement, {
  ...
  interface SkruvOutputHTMLElement extends HTMLVnode<'output', HTMLOutputElement, {
  ...
  interface SkruvProgressHTMLElement extends HTMLVnode<'progress', HTMLProgressElement, {
  ...
  interface SkruvTextareaHTMLElement extends HTMLVnode<'textarea', HTMLTextAreaElement, {
  ...
  interface SkruvDetailsHTMLElement extends HTMLVnode<'details', HTMLDetailsElement, {
  ...
  interface SkruvSummaryHTMLElement extends HTMLVnode<'summary', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** The <dialog> HTML element represents a dialog box or other interactive component, such as a dismissible alert, inspector, or subwindow. */
  interface SkruvDialogHTMLElement extends HTMLVnode<'dialog', HTMLDialogElement, {
  ...
  interface SkruvSlotHTMLElement extends HTMLVnode<'slot', HTMLSlotElement, {
  /** The slot's name.
  ...
  interface SkruvTemplateHTMLElement extends HTMLVnode<'template', HTMLTemplateElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvAcronymHTMLElement extends HTMLVnode<'acronym', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvBigHTMLElement extends HTMLVnode<'big', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvDirHTMLElement extends HTMLVnode<'dir', HTMLDirectoryElement, {
  /** This Boolean attribute hints that the list should be rendered in a compact style. The interpretation of this attribute depends on the user agent and it doesn't work in all browsers. */
  'compact'?: boolean | undefined
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFontHTMLElement extends HTMLVnode<'font', HTMLFontElement, {
  ...
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFrameHTMLElement extends HTMLVnode<'frame', HTMLFrameElement, {
  ...
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFramesetHTMLElement extends HTMLVnode<'frameset', HTMLFrameSetElement, {
  ...
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvMarqueeHTMLElement extends HTMLVnode<'marquee', HTMLMarqueeElement, {
  ...
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvMenuitemHTMLElement extends HTMLVnode<'menuitem', HTMLUnknownElement, {
  ...
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvNoframesHTMLElement extends HTMLVnode<'noframes', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvParamHTMLElement extends HTMLVnode<'param', HTMLParamElement, {
  ...
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvPlaintextHTMLElement extends HTMLVnode<'plaintext', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvRbHTMLElement extends HTMLVnode<'rb', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvRtcHTMLElement extends HTMLVnode<'rtc', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvStrikeHTMLElement extends HTMLVnode<'strike', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvTtHTMLElement extends HTMLVnode<'tt', HTMLElement, {
  }, AnyHTMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvXmpHTMLElement extends HTMLVnode<'xmp', HTMLPreElement, {
  }, AnyHTMLContent> {}
  ...
  interface SkruvASVGElement extends SVGVnode<'a', SVGAElement, {
  ...
  interface SkruvAnimateSVGElement extends SVGVnode<'animate', SVGAnimateElement, {
  }, AnySVGContent> {}
  
  /** The SVG <animateMotion> element provides a way to define how an element moves along a motion path. */
  interface SkruvAnimatemotionSVGElement extends SVGVnode<'animateMotion', SVGAnimateMotionElement, {
  ...
  interface SkruvAnimatetransformSVGElement extends SVGVnode<'animateTransform', SVGAnimateTransformElement, {
  }, AnySVGContent> {}
  
  /** The <circle> SVG element is an SVG basic shape, used to draw circles based on a center point and a radius. */
  interface SkruvCircleSVGElement extends SVGVnode<'circle', SVGCircleElement, {
  ...
  interface SkruvClippathSVGElement extends SVGVnode<'clipPath', SVGClipPathElement, {
  ...
  interface SkruvDefsSVGElement extends SVGVnode<'defs', SVGDefsElement, {
  }, AnySVGContent> {}
  
  /** The <desc> element provides an accessible, long-text description of any SVG container element or graphics element. */
  interface SkruvDescSVGElement extends SVGVnode<'desc', SVGDescElement, {
  }, AnySVGContent> {}
  
  /** The <ellipse> element is an SVG basic shape, used to create ellipses based on a center coordinate, and both their x and y radius. */
  interface SkruvEllipseSVGElement extends SVGVnode<'ellipse', SVGEllipseElement, {
  ...
  interface SkruvFeblendSVGElement extends SVGVnode<'feBlend', SVGFEBlendElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFecolormatrixSVGElement extends SVGVnode<'feColorMatrix', SVGFEColorMatrixElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFecomponenttransferSVGElement extends SVGVnode<'feComponentTransfer', SVGFEComponentTransferElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFecompositeSVGElement extends SVGVnode<'feComposite', SVGFECompositeElement, {
  }, AnySVGContent> {}
  
  /** The <feConvolveMatrix> SVG filter primitive applies a matrix convolution filter effect. A convolution combines pixels in the input image with neighboring pixels to produce a resulting image. A wide variety of imaging operations can be achieved through convolutions, including blurring, edge detection, sharpening, embossing and beveling. */
  interface SkruvFeconvolvematrixSVGElement extends SVGVnode<'feConvolveMatrix', SVGFEConvolveMatrixElement, {
  }, AnySVGContent> {}
  
  /** The <feDiffuseLighting> SVG filter primitive lights an image using the alpha channel as a bump map. The resulting image, which is an RGBA opaque image, depends on the light color, light position and surface geometry of the input bump map. */
  interface SkruvFediffuselightingSVGElement extends SVGVnode<'feDiffuseLighting', SVGFEDiffuseLightingElement, {
  }, AnySVGContent> {}
  
  /** The <feDisplacementMap> SVG filter primitive uses the pixel values from the image from in2 to spatially displace the image from in. */
  interface SkruvFedisplacementmapSVGElement extends SVGVnode<'feDisplacementMap', SVGFEDisplacementMapElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFedistantlightSVGElement extends SVGVnode<'feDistantLight', SVGFEDistantLightElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFedropshadowSVGElement extends SVGVnode<'feDropShadow', SVGFEDropShadowElement, {
  ...
  interface SkruvFefloodSVGElement extends SVGVnode<'feFlood', SVGFEFloodElement, {
  }, AnySVGContent> {}
  
  /** The <feFuncA> SVG filter primitive defines the transfer function for the alpha component of the input graphic of its parent <feComponentTransfer> element. */
  interface SkruvFefuncaSVGElement extends SVGVnode<'feFuncA', SVGFEFuncAElement, {
  }, AnySVGContent> {}
  
  /** The <feFuncB> SVG filter primitive defines the transfer function for the blue component of the input graphic of its parent <feComponentTransfer> element. */
  interface SkruvFefuncbSVGElement extends SVGVnode<'feFuncB', SVGFEFuncBElement, {
  }, AnySVGContent> {}
  
  /** The <feFuncG> SVG filter primitive defines the transfer function for the green component of the input graphic of its parent <feComponentTransfer> element. */
  interface SkruvFefuncgSVGElement extends SVGVnode<'feFuncG', SVGFEFuncGElement, {
  }, AnySVGContent> {}
  
  /** The <feFuncR> SVG filter primitive defines the transfer function for the red component of the input graphic of its parent <feComponentTransfer> element. */
  interface SkruvFefuncrSVGElement extends SVGVnode<'feFuncR', SVGFEFuncRElement, {
  }, AnySVGContent> {}
  
  /** The <feGaussianBlur> SVG filter primitive blurs the input image by the amount specified in stdDeviation, which defines the bell-curve. */
  interface SkruvFegaussianblurSVGElement extends SVGVnode<'feGaussianBlur', SVGFEGaussianBlurElement, {
  }, AnySVGContent> {}
  
  /** The <feImage> SVG filter primitive fetches image data from an external source and provides the pixel data as output (meaning if the external source is an SVG image, it is rasterized.) */
  interface SkruvFeimageSVGElement extends SVGVnode<'feImage', SVGFEImageElement, {
  }, AnySVGContent> {}
  
  /** The <feMerge> SVG element allows filter effects to be applied concurrently instead of sequentially. This is achieved by other filters storing their output via the result attribute and then accessing it in a <feMergeNode> child. */
  interface SkruvFemergeSVGElement extends SVGVnode<'feMerge', SVGFEMergeElement, {
  }, AnySVGContent> {}
  
  /** The feMergeNode takes the result of another filter to be processed by its parent <feMerge>. */
  interface SkruvFemergenodeSVGElement extends SVGVnode<'feMergeNode', SVGFEMergeNodeElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFemorphologySVGElement extends SVGVnode<'feMorphology', SVGFEMorphologyElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFeoffsetSVGElement extends SVGVnode<'feOffset', SVGFEOffsetElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFepointlightSVGElement extends SVGVnode<'fePointLight', SVGFEPointLightElement, {
  }, AnySVGContent> {}
  
  /** The <feSpecularLighting> SVG filter primitive lights a source graphic using the alpha channel as a bump map. The resulting image is an RGBA image based on the light color. The lighting calculation follows the standard specular component of the Phong lighting model. The resulting image depends on the light color, light position and surface geometry of the input bump map. The result of the lighting calculation is added. The filter primitive assumes that the viewer is at infinity in the z direction. */
  interface SkruvFespecularlightingSVGElement extends SVGVnode<'feSpecularLighting', SVGFESpecularLightingElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFespotlightSVGElement extends SVGVnode<'feSpotLight', SVGFESpotLightElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFetileSVGElement extends SVGVnode<'feTile', SVGFETileElement, {
  }, AnySVGContent> {}
  
  /** The <feTurbulence> SVG filter primitive creates an image using the Perlin turbulence function. It allows the synthesis of artificial textures like clouds or marble. The resulting image will fill the entire filter primitive subregion. */
  interface SkruvFeturbulenceSVGElement extends SVGVnode<'feTurbulence', SVGFETurbulenceElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvFilterSVGElement extends SVGVnode<'filter', SVGFilterElement, {
  }, AnySVGContent> {}
  
  /** The <foreignObject> SVG element includes elements from a different XML namespace. In the context of a browser, it is most likely (X)HTML. */
  interface SkruvForeignobjectSVGElement extends SVGVnode<'foreignObject', SVGForeignObjectElement, {
  ...
  interface SkruvGSVGElement extends SVGVnode<'g', SVGGElement, {
  }, AnySVGContent> {}
  
  /** The <image> SVG element includes images inside SVG documents. It can display raster image files or other SVG files. */
  interface SkruvImageSVGElement extends SVGVnode<'image', SVGImageElement, {
  }, AnySVGContent> {}
  
  /** The <line> element is an SVG basic shape used to create a line connecting two points. */
  interface SkruvLineSVGElement extends SVGVnode<'line', SVGLineElement, {
  ...
  interface SkruvLineargradientSVGElement extends SVGVnode<'linearGradient', SVGLinearGradientElement, {
  ...
  interface SkruvMarkerSVGElement extends SVGVnode<'marker', SVGMarkerElement, {
  ...
  interface SkruvMaskSVGElement extends SVGVnode<'mask', SVGMaskElement, {
  ...
  interface SkruvMetadataSVGElement extends SVGVnode<'metadata', SVGMetadataElement, {
  }, AnySVGContent> {}
  
  /** The <mpath> sub-element for the <animateMotion> element provides the ability to reference an external <path> element as the definition of a motion path. */
  interface SkruvMpathSVGElement extends SVGVnode<'mpath', SVGMPathElement, {
  }, AnySVGContent> {}
  
  /** The <path> SVG element is the generic element to define a shape. All the basic shapes can be created with a path element. */
  interface SkruvPathSVGElement extends SVGVnode<'path', SVGPathElement, {
  ...
  interface SkruvPatternSVGElement extends SVGVnode<'pattern', SVGPatternElement, {
  ...
  interface SkruvPolygonSVGElement extends SVGVnode<'polygon', SVGPolygonElement, {
  ...
  interface SkruvPolylineSVGElement extends SVGVnode<'polyline', SVGPolylineElement, {
  ...
  interface SkruvRadialgradientSVGElement extends SVGVnode<'radialGradient', SVGRadialGradientElement, {
  ...
  interface SkruvRectSVGElement extends SVGVnode<'rect', SVGRectElement, {
  ...
  interface SkruvScriptSVGElement extends SVGVnode<'script', SVGScriptElement, {
  ...
  interface SkruvSetSVGElement extends SVGVnode<'set', SVGSetElement, {
  ...
  interface SkruvStopSVGElement extends SVGVnode<'stop', SVGStopElement, {
  ...
  interface SkruvStyleSVGElement extends SVGVnode<'style', SVGStyleElement, {
  ...
  /** The svg element is a container that defines a new coordinate system and viewport. It is used as the outermost element of SVG documents, but it can also be used to embed an SVG fragment inside an SVG or HTML document. */
  interface SkruvSvgSVGElement extends SVGVnode<'svg', SVGSVGElement, {
  /** The minimum SVG language profile that the document requires.
  Value type: <string> ; Default value: none; Animatable: no */
  'baseProfile'?: UNKNOWN | undefined
  /** The default scripting language used by the SVG fragment.
  ...
  interface SkruvSwitchSVGElement extends SVGVnode<'switch', SVGSwitchElement, {
  }, AnySVGContent> {}
  
  /** The <symbol> element is used to define graphical template objects which can be instantiated by a <use> element. */
  interface SkruvSymbolSVGElement extends SVGVnode<'symbol', SVGSymbolElement, {
  ...
  interface SkruvTextSVGElement extends SVGVnode<'text', SVGTextElement, {
  ...
  interface SkruvTextpathSVGElement extends SVGVnode<'textPath', SVGTextPathElement, {
  ...
  interface SkruvTitleSVGElement extends SVGVnode<'title', SVGTitleElement, {
  }, AnySVGContent> {}
  ...
  interface SkruvTspanSVGElement extends SVGVnode<'tspan', SVGTSpanElement, {
  /** The x coordinate of the starting point of the text baseline.
  Value type: <length>|<percentage> ; Default value: none; Animatable: yes */
  'x'?: UNKNOWN | undefined
  /** The y coordinate of the starting point of the text baseline.
  ...
  interface SkruvUseSVGElement extends SVGVnode<'use', SVGUseElement, {
  ...
  interface SkruvViewSVGElement extends SVGVnode<'view', SVGViewElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvMissingGlyphSVGElement extends SVGVnode<'missing-glyph', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFontSVGElement extends SVGVnode<'font', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFontFaceSVGElement extends SVGVnode<'font-face', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFontFaceFormatSVGElement extends SVGVnode<'font-face-format', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFontFaceNameSVGElement extends SVGVnode<'font-face-name', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFontFaceSrcSVGElement extends SVGVnode<'font-face-src', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvFontFaceUriSVGElement extends SVGVnode<'font-face-uri', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvHkernSVGElement extends SVGVnode<'hkern', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvVkernSVGElement extends SVGVnode<'vkern', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvGlyphSVGElement extends SVGVnode<'glyph', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvGlyphrefSVGElement extends SVGVnode<'glyphRef', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvTrefSVGElement extends SVGVnode<'tref', SVGElement, {
  }, AnySVGContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvCursorSVGElement extends SVGVnode<'cursor', SVGElement, {
  }, AnySVGContent> {}
  ...
  /** The <math> MathML element is the top-level MathML element, used to write a single mathematical formula. It can be placed in HTML content where flow content is permitted. */
  interface SkruvMathMathMLElement extends MathMLVnode<'math', MathMLElement, {
  /** This enumerated attribute specifies how the enclosed MathML markup should be rendered. It can have one of the following values:
  ...
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvMactionMathMLElement extends MathMLVnode<'maction', MathMLElement, {
  ...
  interface SkruvSemanticsMathMLElement extends MathMLVnode<'semantics', MathMLElement, {
  ...
  interface SkruvMencloseMathMLElement extends MathMLVnode<'menclose', MathMLElement, {
  ...
  interface SkruvMerrorMathMLElement extends MathMLVnode<'merror', MathMLElement, {
  }, AnyMathMLContent> {}
  
  /** Deprecated: This feature is no longer recommended. Though some browsers might still support it, it may have already been removed from the relevant web standards, may be in the process of being dropped, or may only be kept for compatibility purposes. Avoid using it, and update existing code if possible; see the compatibility table at the bottom of this page to guide your decision. Be aware that this feature may cease to work at any time. */
  interface SkruvMfencedMathMLElement extends MathMLVnode<'mfenced', MathMLElement, {
  ...
  interface SkruvMfracMathMLElement extends MathMLVnode<'mfrac', MathMLElement, {
  ...
  interface SkruvMiMathMLElement extends MathMLVnode<'mi', MathMLElement, {
  }, AnyMathMLContent> {}
  ...
  interface SkruvMmultiscriptsMathMLElement extends MathMLVnode<'mmultiscripts', MathMLElement, {
  ...
  interface SkruvMnMathMLElement extends MathMLVnode<'mn', MathMLElement, {
  }, AnyMathMLContent> {}
  ...
  interface SkruvMoMathMLElement extends MathMLVnode<'mo', MathMLElement, {
  ...
  interface SkruvMoverMathMLElement extends MathMLVnode<'mover', MathMLElement, {
  ...
  interface SkruvMpaddedMathMLElement extends MathMLVnode<'mpadded', MathMLElement, {
  ...
  interface SkruvMphantomMathMLElement extends MathMLVnode<'mphantom', MathMLElement, {
  }, AnyMathMLContent> {}
  ...
  interface SkruvMrootMathMLElement extends MathMLVnode<'mroot', MathMLElement, {
  }, AnyMathMLContent> {}
  ...
  interface SkruvMrowMathMLElement extends MathMLVnode<'mrow', MathMLElement, {
  }, AnyMathMLContent> {}
  ...
  interface SkruvMsMathMLElement extends MathMLVnode<'ms', MathMLElement, {
  ...
  interface SkruvMspaceMathMLElement extends MathMLVnode<'mspace', MathMLElement, {
  ...
  interface SkruvMsqrtMathMLElement extends MathMLVnode<'msqrt', MathMLElement, {
  }, AnyMathMLContent> {}
  
  /** The <mstyle> MathML element is used to change the style of its children. */
  interface SkruvMstyleMathMLElement extends MathMLVnode<'mstyle', MathMLElement, {
  ...
  interface SkruvMsubMathMLElement extends MathMLVnode<'msub', MathMLElement, {
  /** A <length-percentage> indicating the minimum amount to shift the baseline of the subscript down. */
  'subscriptshift'?: UNKNOWN | undefined
  }, AnyMathMLContent> {}
  
  /** The <msup> MathML element is used to attach a superscript to an expression. */
  interface SkruvMsupMathMLElement extends MathMLVnode<'msup', MathMLElement, {
  /** A <length-percentage> indicating the minimum amount to shift the baseline of the superscript up. */
  'superscriptshift'?: UNKNOWN | undefined
  }, AnyMathMLContent> {}
  
  /** The <msubsup> MathML element is used to attach both a subscript and a superscript, together, to an expression. */
  interface SkruvMsubsupMathMLElement extends MathMLVnode<'msubsup', MathMLElement, {
  /** A <length-percentage> indicating the minimum amount to shift the baseline of the subscript down. */
  'subscriptshift'?: UNKNOWN | undefined
  /** A <length-percentage> indicating the minimum amount to shift the baseline of the superscript up. */
  'superscriptshift'?: UNKNOWN | undefined
  ...
  interface SkruvMtableMathMLElement extends MathMLVnode<'mtable', MathMLElement, {
  ...
  interface SkruvMtdMathMLElement extends MathMLVnode<'mtd', MathMLElement, {
  ...
  interface SkruvMtextMathMLElement extends MathMLVnode<'mtext', MathMLElement, {
  }, AnyMathMLContent> {}
  ...
  interface SkruvMtrMathMLElement extends MathMLVnode<'mtr', MathMLElement, {
  ...
  interface SkruvMunderMathMLElement extends MathMLVnode<'munder', MathMLElement, {
  ...
  interface SkruvFeedAtomElement extends AtomVnode<'feed', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvIdAtomElement extends AtomVnode<'id', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvTitleAtomElement extends AtomVnode<'title', Element, {
  
  'type'?: string | undefined
  }, AnyAtomContent> {}
  
  
  interface SkruvUpdatedAtomElement extends AtomVnode<'updated', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvAuthorAtomElement extends AtomVnode<'author', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvNameAtomElement extends AtomVnode<'name', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvUriAtomElement extends AtomVnode<'uri', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvEmailAtomElement extends AtomVnode<'email', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvLinkAtomElement extends AtomVnode<'link', Element, {
  ...
  interface SkruvCategoryAtomElement extends AtomVnode<'category', Element, {
  ...
  interface SkruvContributorAtomElement extends AtomVnode<'contributor', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvGeneratorAtomElement extends AtomVnode<'generator', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvIconAtomElement extends AtomVnode<'icon', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvLogoAtomElement extends AtomVnode<'logo', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvRightsAtomElement extends AtomVnode<'rights', Element, {
  
  'type'?: string | undefined
  }, AnyAtomContent> {}
  
  
  interface SkruvSubtitleAtomElement extends AtomVnode<'subtitle', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvContentAtomElement extends AtomVnode<'content', Element, {
  ...
  interface SkruvSummaryAtomElement extends AtomVnode<'summary', Element, {
  
  'type'?: string | undefined
  }, AnyAtomContent> {}
  
  
  interface SkruvPublishedAtomElement extends AtomVnode<'published', Element, {
  }, AnyAtomContent> {}
  
  
  interface SkruvSourceAtomElement extends AtomVnode<'source', Element, {
  }, AnyAtomContent> {}
  type AnyAtomElement = SkruvFeedAtomElement | SkruvIdAtomElement | SkruvTitleAtomElement | SkruvUpdatedAtomElement | SkruvAuthorAtomElement | SkruvNameAtomElement | SkruvUriAtomElement | SkruvEmailAtomElement | SkruvLinkAtomElement | SkruvCategoryAtomElement | SkruvContributorAtomElement | SkruvGeneratorAtomElement | SkruvIconAtomElement | SkruvLogoAtomElement | SkruvRightsAtomElement | SkruvSubtitleAtomElement | SkruvContentAtomElement | SkruvSummaryAtomElement | SkruvPublishedAtomElement | SkruvSourceAtomElement
  type AnyAtomContent = AnyAtomElement | string | number | boolean | AnyAtomContent[] | AsyncGenerator<AnyAtomContent> | Promise<AnyAtomContent> | (() => AnyAtomContent)
  
  type AnyElement = AnyHTMLElement | AnySVGElement | AnyMathMLElement | AnyAtomElement
  type AnyContent = AnyHTMLContent | AnySVGContent | AnyMathMLContent | AnyAtomContent
